...
\begin{equation}
  \label{eq:Leja-11}
  \begin{split}
    \cos \theta_{ 0 } = \cos \tfr{ \varphi }{ 2 } = \onehalf ( 1 + \cos \varphi
    ),
  \end{split}
\end{equation}
...
\begin{equation}
  \label{eq:Leja-12}
  \begin{split}
    \cos( \tfr{ \varphi }{ 2 } + \pi ) = -\cos( \tfr{ \varphi }{ 2 } ), \quad \sin(
    \tfrac{ \varphi }{ 2 } + \pi ) = -\sin( \tfr{ \varphi }{ 2 } ).
  \end{split}
\end{equation}
...
\begin{equation}
  ...
  \begin{split}
    \left( \sum_{ n = 0 }^{ \infty } a_{ n } z^{ n } \right) \left( \sum_{ m = 0
      }^{ \infty } b_{ m } z^{ m } \right) = \sum_{ n = 0 }^{ \infty }
    ( a_{ n } b_{ 0 } + a_{ n - 1 } b_{ 1 } + \ld + a_{ 0 } b_{ n } )
    z^{ n }.
  \end{split}
\end{equation}
...
\begin{equation}
  ...
  \begin{split}
    \abso{ C_{ n } - A_{ n } B } &= \abso{ a_{ 0 } \beta_{ n } + a_{ 1
      } \beta_{ n - 1 } + \ld + a_{ n } \beta_{ 0 } } \leq \abso{ a_{
        0 } } \abso{ \beta_{ n } } + \abso{ a_{ 1 } } \abso{ \beta_{ n - 1
      } } + \ld + \abso{ a_{ n - p + 1 } } \abso{ \beta_{ p + 1 } } \\
    &+ \abso{ a_{ n - p } \beta_{ p } + \ld + a_{ n } \beta_{ 0 } } \leq \fr{
      \epsilon }{ 2K } ( \abso{ a_{ 0 } } + \ld + \abso{ a_{ n - p + 1
...
\begin{equation}
  ...
  \begin{split}
    \abso{ a_{ n - p } \beta_{ p } + \ld + a_{ n } \beta_{ 0 } } \leq \abso{ a_{
        n - p } } \abso{ \beta_{ p } } + \ld + \abso{ a_{ n } } \abso{
      \beta_{ 0 } } \leq M_{ p } ( \abso{ a_{ n - p } } + \ld + \abso{
      a_{ n } } ),
  \end{split}
\end{equation}
gdzie
...
\begin{equation}
  ...
  \begin{split}
    ...
    \beta_{ 1 } + \ld + \beta_{ n - 1 } ) + B ( \alpha_{ 0 } +
    \alpha_{ 1 } + \ld + \alpha_{ n - 1 } ) + R_{ n },
  \end{split}
\end{equation}
gdzie
\begin{equation}
...
iż~$\abso{ \beta_{ n } } \leq \epsilon / 2 M_{ \alpha }$, dla~$n > p$.
Teraz
\begin{equation}
  \label{eq:Leja-29}
  \begin{split}
    \abso{ r_{ n } } &= \oneOv{ n } \abso{ \alpha_{ n - 1 } \beta_{ 0 } +
      \alpha_{ n - 2 } \beta_{ 1 } + \ld + \alpha_{ n - p - 1 }
      \beta_{ p } + \ld
      + \alpha_{ 0 } \beta_{ n - 1 } } \\
    ...
    &\leq \fr{ p + 1 }{ n } M_{ \alpha } M_{ \beta } + \fr{ n - p - 1 }{ n } M_{
      \alpha } \fr{ \epsilon }{ 2 M_{ \alpha } } = \fr{ p + 1 }{ n }
    M_{ \alpha } M_{ \beta } + \fr{ n - p - 1 }{ n }
    \fr{ \epsilon }{ 2 } \\
...
i~$\tfr{ \difPL }{ \difPL \tau } z( \varphi( \tau ) )|_{ \tau = \tau_{
...
wystarczająca\footnote{Ja~przynajmniej nie znam przypadku, w~którym
  ...
  czy też nie.}, jednak nieścisła. Wystarczy zadać pytanie, czy idziemy
...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \node at (0.55, 1.3 * \radius) {$\mathfrak{Im}\, z$};
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=1.35]
    ...
    \node at (0.4, \scale) {$\mathfrak{Im}\, z$};
...
\begin{equation}
  \label{eq:Leja-40}
  \begin{split}
    \Lim_{ x \to +\infty } e^{ x } = +\infty, \quad \Lim_{ x \to
      -\infty } e^{ -x } = 0, \quad x \in \Rb.
  \end{split}
\end{equation}
