...
\cite{FichtenholzRachunekRozniczkowyVolI2005}), co~potencjalnie może prowadzić
...
jest postaci $\bigcup_{ \iota \in \Ical } I_{ \iota }$ (przy zadanym
...
\begin{proof}
  ...
  \begin{equation}
    ...
    a_{ n } > ( K - \epsilon ) b_{ n }, \quad K - \epsilon > 0.
  \end{equation}
