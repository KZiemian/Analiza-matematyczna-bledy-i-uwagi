...
\begin{subequations}
  ...
  \end{align}
\end{subequations}
Ponieważ $x / \abso{ x } = 1$ dla~$x > 0$ i~$x / \abso{ x } = -1$
...
\start \Str{223} Problem z~tym przykładem jest taki, że
\begin{equation}
  \label{eq:FichtenholzVolII-07}
  \Sum_{ n = 1 }^{ \infty } \frac{ x^{ 2n - 1 } }
  \neq \Sum_{ n = 1 }^{ \infty } \left( \frac{ 1 }{ 1 - x^{ 2n - 1 } }
    - \frac{ 1 }{ 1 - x^{ n } } \right).
\end{equation}
Gdyby tak równość zachodziło, to po pierwsze
\begin{equation}
