...
dodatnio krzywą Jordana. W~praktyce bowiem nazwy konturu używa~się
często dla określenia krzywych zbudowanych z~okręgów, fragmentów
okręgów i~prostych, które~są tylko kawałkami gładkie.

Należy zauważyć, że~pojęcie konturu używa~się w~praktyce nawet
w~ogólniejszych przypadkach, kiedy krzywe mają punkty wielokrotne.
Takie jednak poszerzenie pojęcia konturu, odeszłoby by~chyba zbyt
daleko od~słów Lejii.
...
\textbf{drogi całkowania}, jednak nie jest ono zdefiniowane. Przez
