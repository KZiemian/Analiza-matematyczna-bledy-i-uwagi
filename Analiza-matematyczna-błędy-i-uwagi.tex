...
\red{Nie umiem pokazać, że jedna poziomica $v$ nie może przeciąć
  poziomic $u$ dwa razy.}
...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=1.3]
    ...
    \filldraw [black] (0.57 * \R, 0.82 * \R) circle (1.5pt)
    node [anchor=west] {$R\, e^{ i \varphi }$};
  ...
  \caption{Przykładowy kontur po~którym można całkować funkcje $1 / \zeta$
