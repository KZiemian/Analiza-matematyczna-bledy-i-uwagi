...
\start \Str{73} Przedyskutujemy tu~czy rysunek~36 popranie przedstawia działanie funkcji analitycznej w~otoczeniu punktu $z_{ 0 }$ takiego, że~$f'( z_{ 0 } ) \neq 0$. Okazuje~się, że~w~pewnym otoczeniu tego punktu istotnie sytuacja musi wyglądać tak jak na~tym rysunku.

przedstawia zachowanie krzywych $u( x, y ) = c$
