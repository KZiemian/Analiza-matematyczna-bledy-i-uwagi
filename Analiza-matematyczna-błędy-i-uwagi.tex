...
Wyżej zostało pokazane, że~istnieje koło $K( z_{ 0 }, \delta )$ takie, że~$f( z )$ przyjmuje każdą wartość z~koła $K( f( z_{ 0 } ), \eta )$ dokładnie w~jednym punkcie tego koła, może~się jednak zdarzyć, że~$f( K( z_{ 0 }, \delta ) ) \neq K( f( z_{ 0 } ), \eta )$, bowiem $K( f( z_{ 0 } ), \eta ) \subsetneq f( K( z_{ 0 }, \delta ) )$.
