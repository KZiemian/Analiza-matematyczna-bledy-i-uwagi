...
\begin{equation}
  \label{eq:Leja-11}
  \begin{split}
    \cos \theta_{ 0 } = \cos \tfr{ \varphi }{ 2 } = \onehalf ( 1 +
    \cos \varphi ),
  \end{split}
\end{equation}
...
\begin{equation}
  ...
  \begin{split}
    ...
    ), \quad \sin( \tfrac{ \varphi }{ 2 } + \pi ) = -\sin( \tfr{
      \varphi }{ 2 } ).
  \end{split}
\end{equation}
...
\begin{equation}
  \label{eq:Leja-14}
  \begin{split}
    \abso{ C_{ n } - A_{ n } B } \leq \epsilon, \quad \forall \epsilon
    > 0,
  \end{split}
\end{equation}
...
\begin{equation}
  ...
  \begin{split}
    \abso{ C_{ n } - A_{ n } B } &= \abso{ a_{ 0 } \beta_{ n } + a_{ 1
        ...
        0 } } \abso{ \beta_{ n } } + \abso{ a_{ 1 } } \abso{ \beta_{ n
        - 1
      } } + \ld + \abso{ a_{ n - p + 1 } } \abso{ \beta_{ p + 1 } } \\
    &+ \abso{ a_{ n - p } \beta_{ p } + \ld + a_{ n } \beta_{ 0 } }
    \leq \fr{ \epsilon }{ 2K } ( \abso{ a_{ 0 } } + \ld + \abso{ a_{ n
        - p + 1 } } ) + \abso{ a_{ n - p } \beta_{ p } + \ld + a_{ n }
      \beta_{ 0 } }.
  \end{split}
\end{equation}
...
\begin{equation}
  \label{eq:Leja-21}
  \begin{split}
    R_{ n } = n r_{ n } = \alpha_{ n - 1 } \beta_{ 0 } + \alpha_{ n -
      2 } \beta_{ 1 } + \ld + \alpha_{ 0 } \beta_{ n - 1 }.
  \end{split}
\end{equation}
...
\begin{equation}
  ...
  \begin{split}
    C_{ 0 } + C_{ 1 } + \ld + C_{ n - 1 } + C_{ n } &= n AB + A \sum_{
      i = 0 }^{ n - 1 } \beta_{ i } + B \sum_{ i = 0 }^{ n - 1 }
    \alpha_{ i } + R_{ n } + C_{ n }.
  \end{split}
\end{equation}
...
\begin{equation}
  \label{eq:Leja-25}
  \begin{split}
    C_{ n } = AB + A \beta_{ n } + B \alpha_{ n } - R_{ n } + R_{ n +
      1 }.
  \end{split}
\end{equation}
...
\begin{equation}
  ...
  \begin{split}
    ...
    \alpha_{ n - 1 } )
    ( \beta_{ 1 } - \beta_{ 0 } ) \\
    &+ ( A + \alpha_{ n - 2 } )( \beta_{ 2 } - \beta_{ 1 } ) + \ld + (
    A + \alpha_{ 0 } ) ( \beta_{ n } - \beta_{ n - 1 } )
    = AB + B \alpha_{ n } + \alpha_{ n } \beta_{ 0 } \\
    &+ A \beta_{ 0 } + A ( \beta_{ 1 } - \beta_{ 0 } + \beta_{ 2 } -
    \beta_{ 1 } + \ld + \beta_{ n } - \beta_{ n - 1 } ) + \alpha_{ n -
      1 } ( \beta_{ 1 } - \beta_{ 0 } )
    + \alpha_{ n - 2 } ( \beta_{ 2 } - \beta_{ 1 } ) \\
    & + \ld + \alpha_{ 0 } ( \beta_{ n } - \beta_{ n - 1 } ) = AB + A
    \beta_{ n } + B \alpha_{ n } + \alpha_{ n } \beta_{ 0 } + \alpha_{
      n - 1 } \beta_{ 1 } +
    \alpha_{ n - 2 } \beta_{ 2 } + \ld + \alpha_{ 0 } \beta_{ n } \\
    & - ( \alpha_{ n - 1 } \beta_{ 0 } + \alpha_{ n - 2 } \beta_{ 1 }
    + \ld + \alpha_{ 0 } \beta_{ n - 1 } ) = AB + A \beta_{ n } + B
    \alpha_{ n } + R_{ n + 1 } - R_{ n }.
  \end{split}
\end{equation}
...
\begin{equation}
  \label{eq:Leja-28}
  \begin{split}
    \abso{ M_{ \alpha } } \leq M_{ \alpha }, \quad \abso{ \beta_{ n }
    } \leq M_{ \beta }.
  \end{split}
\end{equation}
Ustalmy teraz $\epsilon > 0$. Skoro $\beta_{ n }$ jest zbieżny do~0,
...
\begin{equation}
  ...
  \begin{split}
    \abso{ r_{ n } } &= \oneOv{ n } \abso{ \alpha_{ n - 1 } \beta_{ 0
      ...
      \beta_{ p } + \ld
      + \alpha_{ 0 } \beta_{ n - 1 } } \\
    &\leq \oneOv{ n } \abso{ \alpha_{ n - 1 } \beta_{ 0 } + \alpha_{ n
        - 2 } \beta_{ 1 } + \ld + \alpha_{ n - p - 1 } \beta_{ p } } +
    \oneOv{ n }
    \abso{ \alpha_{ n - p - 2 } \beta_{ p + 1 } + \ld + \alpha_{ 0 } \beta_{ n - 1 } } \\
    &\leq \fr{ p + 1 }{ n } M_{ \alpha } M_{ \beta } + \fr{ n - p - 1
    }{ n } M_{ \alpha } \fr{ \epsilon }{ 2 M_{ \alpha } } = \fr{ p + 1
    }{ n } M_{ \alpha } M_{ \beta } + \fr{ n - p - 1 }{ n }
    \fr{ \epsilon }{ 2 } \\
    &\leq \fr{ \epsilon }{ 2 } + \fr{ p + 1 }{ n } M_{ \alpha } M_{
      \beta }.
  \end{split}
\end{equation}
