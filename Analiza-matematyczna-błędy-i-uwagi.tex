...
z~reguł mnożenia. Teraz możemy \emph{zdefiniować} liczbę $1 / z$
wzorem
\begin{equation}
  \label{eq:Leja-3}
  \begin{split}
...
da~się sparametryzować w~sposób naturalny????. Jest to wciąż możliwe,
jeśli tych punktów jest ,,odpowiednio mało''. Przykładem takiej
