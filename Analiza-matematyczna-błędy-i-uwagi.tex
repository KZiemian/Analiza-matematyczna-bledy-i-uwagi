...
zespolone~$\C$, wówczas takiej funkcji jednowartościowej nie~da~się
...
$\sqrt[ n ]{ \cdot }: z \mapsto \sqrt[ n ]{ z }$ na~pewnych właściwych podzbiorach $\C$. Wynika to~między innymi z~twierdzenia o~istnieniu jednoznacznych gałęzi logarytmu, zobacz str.~95 w~komentowanej tu~książce \cite{LejaFunkcjeZespolone2006}. Tym problemem nie będziemy~się w~tym miejscu szerzej zajmować.
...
\begin{equation}
  \label{eq:Leja-27}
  \begin{split}
    \abso{ r_{ n } } &= \oneOv{ n } \abso{ \al_{ n - 1 } \be_{ 0 } +
      \al_{ n - 2 } \be_{ 1 } + \ld + \al_{ n - p - 1 } \be_{ p } +
      \ld
      + \al_{ 0 } \be_{ n - 1 } } \\
    &\leq \oneOv{ n } \abso{ \al_{ n - 1 } \be_{ 0 } + \al_{ n - 2 }
      \be_{ 1 } + \ld + \al_{ n - p - 1 } \be_{ p } } + \oneOv{ n }
    \abso{ \al_{ n - p - 2 } \be_{ p + 1 } + \ld + \al_{ 0 } \be_{ n - 1 } } \\
