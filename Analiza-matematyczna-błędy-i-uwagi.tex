...
\start \Str{32} Podana tu definicji jest z~praktycznego punktu
widzenie wystarczająca\footnote{Ja~przynajmniej nie znam przypadku,
  gdy~była ona~niewystarczający.}, jednak nieścisła. Wystarczy zadać
pytanie, czy idziemy po~krzywej ,,głową do~góry'', czy~,,głową
do~dołu''?
...
\start \Str{94} W~punkcie \S 7 należy zauważyć, że~przez drogę można
rozumieć tylko krzywe kawałkami gładką. W~przeciwnym wypadku nie można
stosować udowodnionych twierdzeń o~całkach.
